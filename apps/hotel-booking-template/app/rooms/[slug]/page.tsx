...
import { ArrowLeft, BedDouble, Check, Eye, Ruler, Star, Users } from "lucide-react"
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!room) return {}
  return {
    title: `${room.name} — Maison Lumière`,
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 p-5 bg-secondary/50 border border-border">
              <Detail icon={Ruler} label="Size" value={`${room.size} m²`} />
              <Detail icon={Users} label="Capacity" value={`${room.capacity} guests`} />
              <Detail icon={BedDouble} label="Beds" value={room.beds} />
              <Detail icon={Eye} label="View" value={room.view} />
            </div>
            ...
            <div className="mt-8">
              <h3 className="eyebrow mb-4">In this suite</h3>
            ...
            <div className="mt-10 pt-8 border-t border-border">
              ...
              >
                <Link href={`/book?room=${room.slug}`}>Reserve This Suite</Link>
              </Button>
