    ...
    <section className="bg-secondary/50 py-20 md:py-32">
      <div className="container-luxe">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14 md:mb-20">
          <div>
            <p className="eyebrow text-accent mb-4">Rooms & Suites</p>
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl leading-[1.05] text-balance max-w-2xl">
              Sixty-four places to fall
              <br />
              gently <span className="italic">asleep</span>.
            </h2>
          </div>
          <Link
            href="/rooms"
          ...
          >
            All Accommodations <ArrowUpRight className="h-4 w-4" />
          </Link>
        </div>
