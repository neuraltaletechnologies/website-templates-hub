        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-5">
            <h3 className="font-serif text-3xl md:text-4xl leading-tight text-balance">
              Receive our quiet dispatches — seasonal offers, new menus,
              and stories from the coast.
            </h3>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-10">
            ...
            <FooterColumn
              title="Reach Us"
              links={[
                { label: "Nungwi Beach, Zanzibar", href: "#" },
                { label: "+255 774 000 000", href: "tel:+255774000000" },
                { label: "stay@maisonlumiere.co", href: "mailto:stay@maisonlumiere.co" },
                { label: "Concierge 24/7", href: "/contact" },
              ]}
            />
          </div>
        </div>
