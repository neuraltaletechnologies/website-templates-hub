    ...
    <section className="relative">
      <div className="relative h-[520px] md:h-[620px] w-full overflow-hidden">
        <Image
          ...
          alt="Sunset over the Tanzanian safari circuit"
          fill
          sizes="100vw"
        ...
        <div className="relative container-luxe h-full flex flex-col items-center justify-center text-center text-background">
          <p className="eyebrow text-accent mb-6">Your next journey</p>
          <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[1] text-balance max-w-4xl">
            Begin your <span className="italic">safari</span>.
          </h2>
          <p className="mt-8 text-base md:text-lg text-background/80 max-w-xl leading-relaxed">
            Our team is ready to help you build the right itinerary —
            whichever mix of wildlife, mountains, culture, and coast fits
            your trip.
          </p>
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4">
            ...
            >
              <Link href="/book">Plan My Safari</Link>
            </Button>
            <Button
              asChild
              size="lg"
            ...
            >
              <Link href="/contact">
                Talk to Our Team <ArrowUpRight className="h-4 w-4 ml-2" />
              </Link>
            </Button>
          </div>
        </div>
