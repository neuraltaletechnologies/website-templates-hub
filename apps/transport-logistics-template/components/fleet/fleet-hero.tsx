    ...
    <section className="relative py-24 bg-gradient-to-br from-primary via-primary to-primary/90 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <span className="text-primary-foreground">Our Fleet</span>
        </motion.nav>
        ...
        <div className="max-w-3xl">
          ...
          >
            Our state-of-the-art fleet of trucks, aircraft, and vessels ensures your cargo 
            is transported safely and efficiently across land, air, and sea. Every vehicle 
            is GPS-tracked and maintained to the highest standards.
          </motion.p>
        </div>
      </div>
