    ...
    <section className="relative py-24 bg-gradient-to-br from-primary via-primary to-primary/90 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <span className="text-primary-foreground">Get a Quote</span>
        </motion.nav>
        ...
        <div className="max-w-3xl">
          ...
          >
            Fill out the form below to receive a customized shipping quote within 24 hours. 
            Our team will analyze your requirements and provide competitive rates.
          </motion.p>
        </div>
      </div>
