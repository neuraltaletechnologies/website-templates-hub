    ...
    <section className="relative py-24 bg-gradient-to-br from-primary via-primary to-primary/90 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <span className="text-primary-foreground">Track Shipment</span>
        </motion.nav>
        ...
        <div className="max-w-3xl">
          ...
          >
            Enter your tracking number to get real-time updates on your shipment location, 
            estimated delivery time, and complete journey history.
          </motion.p>
        </div>
      </div>
